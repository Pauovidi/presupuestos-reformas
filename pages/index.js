...
export default function Home(){
  ...
  const exportJSON = ()=>{
    ...
    a.href = url; a.download = "calculo_reforma.json"; a.click();
      ...
      <header className="dark-header">
        <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <nav className="space-x-3 text-sm">
            ...
            <Link href="/chat" className="hover:underline">Chat asistido</Link>
            <a href="#" className="btn btn-ghost" onClick={(e)=>{e.preventDefault(); exportJSON();}}>Export JSON</a>
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select className="input" value={input.tipoObra} onChange={e=>update({tipoObra: e.target.value})}>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={k} className="space-y-2">
                  ...
                  <input className="input" placeholder="€/m² aplicación"
                    type="number" value={input[`alic_${k}_apl`]}
                    onChange={e=>update({[`alic_${k}_apl`]: parseFloat(e.target.value)||0})}/>
                  <input className="input" placeholder="€/m² material"
                    type="number" value={input[`alic_${k}_mat`]}
                    onChange={e=>update({[`alic_${k}_mat`]: parseFloat(e.target.value)||0})}/>
                  <input className="input" placeholder="m² a alicatar"
                    type="number" value={input[`alic_${k}_m2`]}
          ...
          <div className="card">
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {params.precios.falsoTecho_m2} €/m² (editable en parámetros)
                </p>
              </div>
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {params.precios.falsoTechoTecnico_m2} €/m² (editable en parámetros)
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  {params.precios.habitacion_fija} € / habitación (editable)
                </p>
              </div>

              <div>
                <label className="label">Tabiquería interior</label>
                <select className="input" value={input.tabiqueria_tipo}
              ...
              <div>
                ...
                <select className="input" value={input.cocina ? "Sí":"No"}
              ...
              <div>
                ...
                <select className="input" value={input.incluirFontaneria ? "Sí":"No"}
              ...
              <div>
                ...
                <select className="input" value={input.incluirElectricidad ? "Sí":"No"}
              ...
              <div>
                ...
                <select className="input" value={input.calidad}
              ...
              <div>
                ...
                <select className="input" value={input.ciudad}
